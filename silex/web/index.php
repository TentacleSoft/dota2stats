...
$app->get('/', function() use ($app) {
	...
	return $app['twig']->render('match_list.twig', array('matches' => $data));
});
...
$app->get('/match/{match_id}/', function($match_id) use ($app) {
    ...
    return $app['twig']->render('match.twig', array('match' => $data));
});
...
$app->get('/match/{match_id}/details/', function($match_id) use ($app) {
    ...
    return $app['twig']->render('match_details.twig', array('match' => $data));
});
